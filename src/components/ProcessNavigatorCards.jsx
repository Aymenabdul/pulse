            ...
            <Grid container spacing={2.5} alignItems="stretch">
                <Grid size={{ xs: 12, sm: 6 }}>
                    ...
                    >
                      ...
                      >
                        <InsertDriveFileIcon sx={{ fontSize: 28, color: '#2196F3' }} />
                      </Box>
                      ...
                      >
                        Upload and review submitted survey data in table format
                      </Typography>
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                    ...
                    >
                      ...
                      >
                        Manage and approve user signups for platform access
                      </Typography>
